...
let content = fs.readFileSync('src/components/AICanvasView.tsx', 'utf-8');

// We just replace the whole file since it's easier.
...
`
fs.writeFileSync('src/components/AICanvasView.tsx', newContent);
